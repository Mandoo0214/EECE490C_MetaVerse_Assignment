...
{
#if PC
    public enum ButtonTarget //input에 관련한 button을 정리해 둔 것
    {
        Fire1,
        Fire2,
        Fire3,
    ...
    public enum Button //input과 button을 mapping
    {
#if PC
    ...
    public static Vector3 RHandPosition
    {
        get
        {
            ...
            // z 값은 0.7m로 설정
            pos.z = 0.7f;
            // 스크린 좌표를 월드 좌표로 변환->2D인 screen에서 3D인 build로 변환 mapping 
    ...
    public static Vector3 RHandDirection //방향 가져오는 것
    {
        get
        {
#if PC
